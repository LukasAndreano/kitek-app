		...
		<Fragment>
			...
			<Group>
				<Banner
					...
					subheader={
						<React.Fragment>
							И да, это не шутка — приложение перестанет работать уже в этот понедельник. <br/><br/>К сожалению, это вынужденая мера: доработка и поддержка приостановлена <a href={"https://vk.com/darkflamept"} target={"_blank"}>разработчиком</a>.
						</React.Fragment>
					}
				/>
