  ...
  return (
    <Fragment>
      ...
      <Group>
        ...
        <RichCell
          caption={timeStorage.tab === 1 ? "с 8:45 до 10:15" : "с 8:45 до 9:55"}
          multiline
          disabled
          before={
        ...
        <RichCell
          caption={
            timeStorage.tab === 1 ? "с 10:25 до 11:10" : "с 10:00 до 10:40"
          }
          multiline
          disabled
          before={
        ...
        <RichCell
          caption={
            timeStorage.tab === 1 ? "с 11:10 до 11:40" : "с 10:40 до 11:00"
          }
          multiline
          disabled
          before={
        ...
        <RichCell
          caption={
            timeStorage.tab === 1 ? "с 11:40 до 12:25" : "с 11:00 до 11:30"
          }
          multiline
          disabled
          before={
        ...
        <RichCell
          caption={
            timeStorage.tab === 1 ? "с 12:35 до 14:05" : "с 11:35 до 12:45"
          }
          multiline
          disabled
          before={
        ...
        <RichCell
          caption={
            timeStorage.tab === 1 ? "с 14:15 до 15:45" : "с 12:50 до 14:00"
          }
          multiline
          disabled
          before={
        ...
        <RichCell
          caption={
            timeStorage.tab === 1 ? "с 15:55 до 17:25" : "с 14:05 до 15:15"
          }
          multiline
          disabled
          before={
        ...
        <RichCell
          caption={
            timeStorage.tab === 1 ? "с 17:35 до 19:05" : "с 15:20 до 16:30"
          }
          multiline
          disabled
          before={
            <Avatar size={40} src={""} mode="app" style={{ marginTop: 14 }}>
              <span className="TopText" style={{ marginTop: -4 }}>
                6
              </span>
            </Avatar>
