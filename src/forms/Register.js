	...
	return (
		<Fragment>
			<Placeholder
				...
				header="Приветствуем!"
			>
				Для создания аккаунта введите свой действующий адрес электронной
				почты и придумайте пароль минимум из 5 символов, а затем нажмите
				на кнопку «Создать аккаунт». Если у Вас уже есть аккаунт, то{" "}
				<Link onClick={() => dispatch(setCurrentForm(1))}>войдите</Link>{" "}
				в него его прямо сейчас.
			</Placeholder>
