...
export default function Login() {
	...
	return (
		<Fragment>
			...
			>
				Для входа в аккаунт введите свой действующий EMail и пароль, а
				после чего нажмите на кнопку «Войти в аккаунт». Если у Вас еще
				нет аккаунта, то{" "}
				<Link onClick={() => dispatch(setCurrentForm(0))}>
					создайте
				</Link>{" "}
				его прямо сейчас.
			</Placeholder>
