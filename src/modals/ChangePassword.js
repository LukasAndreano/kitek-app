...
export default function ChangePassword(props) {
  ...
  return (
    <Group>
      ...
      >
        Если кто-то узнал Ваш текущий пароль или у Вас появилось желание его
        обновить, то эта страница для Вас. После смены пароля выполнится выход
        из аккаунта на всех устройствах, которые были авторизованы.
      </Placeholder>
      <FormLayout
        onSubmit={(e) => {
          e.preventDefault();
      ...
      >
        ...
        <FormItem
          ...
          bottom={
            showPasswordError2 && "Пароль должен состоять минимум из 5 символов"
          }
        ...
        <FormItem
          ...
          bottom={
            showPasswordError3 && "Пароль должен состоять минимум из 5 символов"
          }
